  ...
  const submit = async () => {
    ...
    try {
      ...
      if (!isBulk) {
        ...
        if (!rowIds.length) return toast.error("No valid rows selected");
        ...
        {targetMode === "existing" ? (
          ...
          <>
            ...
            <input
              ...
              className="mt-2 w-full px-4 py-3 rounded-2xl border border-gray-200 bg-white focus:outline-none"
