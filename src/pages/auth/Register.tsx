...
export default function Register() {
  ...
  return (
    <div className="w-full md:w-[60%] min-h-[100vh] flex items-center justify-center px-6 py-8">
      ...
      <div
        className={`card fixed top-0 left-0 w-full h-full p-10 z-50 ${!modalVisible ? "hidden" : "flex"}  bg-[#1f1f1f59] justify-content-center`}
      >
        ...
        >
          ...
          <div className=" text-center flex flex-col gap-3 mx-5">
            ...
            <p className="text-gray-500">
              ...
              proceed to verify. <br />
              <span className="text-xs text-gray-400">
                (Check your Spam or Junk folder if you don't see it in a few
                minutes)
              </span>
            </p>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-green-600 font-medium">
            free 200 credits on sign up
          </p>
          <div className="text-xs text-gray-500 p-2 m-2 bg-red-50 rounded-lg">
            By signing up below, you agree to LeadCourt's{" "}
            <i className="underline text-800">
